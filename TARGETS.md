...
| Permutation groups and Cayley-CI pipeline | Cayley-CI atlas, derivative-orbit, and coherent-configuration routes | Exact permutation orbits, deterministic Schreier-Sims order/membership, explicit double cosets, inverse-closed subset quotients, batched Cayley construction, R-0805 derivative orbits, and 2-WL basic relations with intersection numbers through degree/order 512. The complete 13-group atlas reproduces 11,664 first-quotient orbits and 9,606 graph fibers exactly; retained median speedups are 2.189193803654373x end to end and 988.2385755592494x for a representative GAP-shellout group query. |
