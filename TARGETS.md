...
| Permutation groups and Cayley-CI pipeline | Cayley-CI atlas, derivative-orbit, and coherent-configuration routes | Exact permutation orbits, deterministic Schreier-Sims order/membership, explicit double cosets, complete-action and generated-action inverse-closed subset quotients, native atom expansion, batched Cayley construction, parallel single-pass nauty, R-0805 derivative orbits, and 2-WL basic relations with separate refinement-only output or verified intersection numbers through degree/order 512. The complete 13-group atlas reproduces 11,664 first-quotient orbits and 9,606 graph fibers exactly in 0.12926016957499087 s median: 18.980477590430294x faster than the prior native path and 40.14429013199191x faster than Python/NetworkX/`labelg`. The exact Q60 shard improves 2.227806721290944x; a representative GAP-shellout group query remains 988.2385755592494x slower than native. |
